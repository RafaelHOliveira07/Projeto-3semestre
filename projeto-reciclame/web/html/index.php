  ...
  <main class=" container-fluid">
    ...
    <section class="sec-01 container-fluid">
      ...
      <div class="img-sec container-fluid" data-aos="fade-right" data-aos-offset="200" data-aos-delay="50"
        data-aos-duration="800" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true">
        <label for="tecb">
          <img class="img-fluid" src="../img/tecnologia.png" alt="tec" id="tec"><span>Para Empresas Privadas</span></label>
        <div class="p">
          <p>Nossos Pontos de Coleta Inteligente podem ser para qualquer tipo de material que nossos clientes precisam, tendo um vista sua maior necessidade para determinado material. Tendo um suporte para informações onde nosso Sistema envia uma notificação para efetuar a coleta, ficando assim mais otimizado o trabalho de reciclagem</p>
        </div>
      </div>
