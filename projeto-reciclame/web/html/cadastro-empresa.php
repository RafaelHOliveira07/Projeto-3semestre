        ...
        <form action="gravar-empresa.php" method="POST">
            ...
            <div class="form-row panel">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="cnpj" name="cnpj" placeholder="CNPJ" required></label>
                </div>
            </div>
            <div class="form-row panel">
                <div class="form-group col-md-6">
            ...
            <div class="form-row panel">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="endereco" placeholder="Rua/Avenida" required></label>
                </div>
                <div class="form-group col-md-4">
         ...
         <div><h2 style="">Cadastra-se Agora e utilize os dados gerados pela nossa plataforma</h2></div>
    </main>
