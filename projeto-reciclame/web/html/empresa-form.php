...
<body class="text-center flex-column">
  ...
  <form action="empresa-login.php" method="post" class="form-signin" name="login" onsubmit="return validaCampo(); return false;">
  ...
  <span>ainda não possue uma conta para sua Empresa? <a href="cadastro-empresa.php">Clique aqui</a> para se cadastrar.</span>
  </form>
</body>
